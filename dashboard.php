...
// Expense Limit
$userid = $_SESSION['detsuid'];
$query6 = mysqli_query($con, "SELECT DailyLimit FROM expenselimits WHERE UserId = '$userid'");
$result6 = mysqli_fetch_array($query6);
$DailyLimit = $result6['DailyLimit'];
?>
<div class="easypiechart" id="easypiechart-green" data-percent="<?php echo $DailyLimit; ?>"><span class="percent"><?php echo $DailyLimit !== "" ? $DailyLimit : "90"; ?></span></div>
